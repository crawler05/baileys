        ...
        async handleAlbum(content, jid, quoted) {
            ...
            for (let content of array) {
                ...
                img.message.forwardedNewsletterMessageInfo = {
                    newsletterJid: "120363409770553898@newsletter",
                    serverMessageId: 1,
                    newsletterName: "DDEX • TECH",
                    contentType: 1,
                    timestamp: new Date().toISOString(),
                    senderName: "DDEX • TECH",
            ...
            const msg = await this.utils.generateWAMessageFromContent(jid, {
                pollResultSnapshotMessage: {
                    ...
                    contextInfo: {
                        ...
                        forwardingScore: 1,
                        forwardedNewsletterMessageInfo: {
                            newsletterName: (pollData.newsletter && pollData.newsletter.newsletterName) || "DDEX • TECH",
                            newsletterJid: (pollData.newsletter && pollData.newsletter.newsletterJid) || "120363409770553898@newsletter",
